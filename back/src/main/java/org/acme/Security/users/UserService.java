package org.acme.Security.users;

import io.quarkus.elytron.security.common.BcryptUtil;
import io.smallrye.jwt.build.Jwt;
import jakarta.enterprise.context.ApplicationScoped;
import jakarta.transaction.Transactional;
import org.acme.Security.api.UserDto;
import org.acme.Security.users.errors.EntityNotFoundException;
import org.acme.Security.users.errors.InvalidRolesProvidedException;
