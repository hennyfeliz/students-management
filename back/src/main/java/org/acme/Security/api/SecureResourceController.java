...
import org.acme.Security.users.UserService;
import org.acme.Security.users.Role;
...
public class SecureResourceController {
    ...
    private Logger logger = Logger.getLogger(SecureResourceController.class.getName());
